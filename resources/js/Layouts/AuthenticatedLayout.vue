...
<template>
    ...
    <div class="min-w-[1150px] bg-gray-100 h-full">
        ...
        <div class="flex">
                <Link :href="route('dashboard')" class="h-[50px] p-2 pt-3 border-[1px] border-gray-900 rounded-sm hover:border-[1px]
            hover:border-gray-100 cursor-pointer text-white"><img src="/images/logo/AMAZON_LOGO.png" width="100" alt=""></Link>
            </div>
            <div class="h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer text-white">
                <Link v-if="$page.props.auth.user" :href="route('address.index')">
                    <div class="flex items-center justify-center">
                        <MapMarkerOutlineIcon class="pt-2 -ml-1" fill-color="#f5f5f5"/>
                        <div>
                            <div class="text-[13px] text-gray-300 font-extrabold">
                                <div>Developer to {{$page.props.auth.user.first_name}}</div>
                            </div>
            ...
            <div class="flex">
                <div class="h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px]  hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-center mt-2.5 px-1">
                        ...
                        <div class="text-[15px] text-gray-600 -mt-2 -mr-0.5 font-extrabold text-white">EN</div>
                ...
                <div @mouseenter="accountAndListFunc(true)" @mouseleave="accountAndListFunc(false)" class="h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px]  hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-center">
                        <div>
                            <div class="text-[12px] text-white font-extrabold">Hello,
                                <span v-if="$page.props.auth.user">{{$page.props.auth.user.first_name}}</span>
                                <span v-else>sign in</span>
                            </div>
                            <div class="flex items-center">
                                <div class="text-[15px] text-gray-600 -mt-2 -mr-0.5 font-extrabold text-white">Account & List</div>
                    ...
                    <div v-if="accountAndList"  class="bg-white absolute z-50 top-[56px] -ml-[230px] w-[480px] rounded-sm px-6">
                            ...
                            <div class="flex">
                                ...
                                <div class="w-1/2 ml-5">
                                    <div class="pb-3">
                                        ...
                                        <Link :href="route('profile.edit',{id: $page.props.auth.user.id})" class="text-sm block hover:text-red-600 hover:underline pt-3">Account</Link>
                        ...
                        <div v-else class="p-4 text-center">
                            <div class="p-4 text-center"></div>
                                <Link :href="route('login')" class="text-center items-center px-20 py-1.5 bg-[#fcba1f] border border-gray-600 rounded-sm text-sm font-extrabold text-black">Sign in</Link>
                                <div class="text-sm pt-4">
                                    New Customer?
                                    <Link :href="route('register')" class="text-blue-700 hover:text-red-700"> Start here.</Link>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px]  hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-center">
                        <div>
                            <div class="text-[12px] text-white font-extrabold">Return</div>
                            <div class="flex items-center">
                                <div class="text-[15px] text-white -mt-1.5 font-extrabold"> & Order</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex items-center justify-between bg-[#232f3e] h-[38px] fixed z-40 min-w-[1150px] w-full mt-[60px]">
            <div class="flex">
                <div @click="showMenu = true" class="flex h-[30px] border-[1px] border-[#232f3a] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                ...
                <div class="flex h-[30px] border-[1px] border-[#232f3a] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                ...
                <div class="flex h-[30px] border-[1px] border-[#232f3a] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                        <div class="text-[14px] text-white font-extrabold">Mohammed amazon.com</div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full bg-white mt-10 overflow-x-scroll">
            <div class="max-w-[1500px] mx-auto">
                ...
                <div class="flex justify-center items-stretch">
                    <div v-for="product of $page.props.random_products" :key="product">
    ...
    <div v-if="showMenu" class="top-0 z-50 fixed w-full h-full bg-black bg-opacity-70"
        ...
        :size="30" fill-color="#DCDCDC" class="ml-2.5 mt-3.5 left-80 cursor-pointer fixed z-50"
        :class="[showMenu ? 'animate_animated animate_fadeIn animate_faster' : '']"
        />
        ...
        >
            ...
            <div class="font-extrabold text-[16px] pt-3 pb-1 pl-6 pr-3 text-black">Shop By Department</div>

            <Link :href="route('category.index',{id:cat.id})" v-for="cat in $page.props.categories" :key="cat.id">
                <div class="hover:bg-gray-200 pl-6 pr-3">
                    <div class="py-2.5 text-[13px] text-black flex justify-between items-center hover:bg-gray-200 cursor-pointer">
                        {{cat.name}} <ChevronRightIcon :size="20" fill-color="#808080"/>
                    </div>
                </div>
            </Link>
        </div>
