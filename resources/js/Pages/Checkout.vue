...
import {useForm, Head,Inertia } from "@inertiajs/vue3";
...
onMounted(() => {
    stripe = Stripe("pk_test_51PvLQnBaRdacjjhQSyag9tcXd5HJaHFBdgasnOmXs3RVH8GP4ApotWSUNbBdZimsvgEqB8NXNETc65j9VwcUnIMo00WbbHn1IV");
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex max-w-[1250px] mx-auto pt-4">
            ...
            <form id="payment-form">
                ...
                <button id="submit" class="bg-yellow-400 hover:bg-yellow-500 text-sm font-bold p-2 rounded-md">
<!--                    <div v-if="isProcessing" id="button-text">Processing ...</div>-->
<!--                    <div v-else id="button-text">Place Your Order in UDS</div>-->
                    <div class="" id="button-text">Place Yourn Order in USD</div>
                </button>
        ...
        <div class="w-[1200px] mx-auto">
            <div class="flex items-center py-1">PROD DETATLS HERE</div>
        </div>
    </AuthenticatedLayout>
</template>
