...
const isAlreadyInCart = computed(() => {
    let res = cart.value.find(item => item.id === product.value.id);
    if (res) return true;
    return false;
});
</script>
       ...
       <div class="max-w-[1200px] mx-auto flex gap-4 justify-between">
           ...
           <div class="w-2/5">
               <div class="text-xl font-extrabold border-b border-b-gray-300 mb-2 pb-2">{{product.title}}</div>
                <div class="">
                    <div class="text-lg font-extrabold m-l">
                        About this Item
                    </div>
               ...
               <div class="border border-gray-300">
                   <div class="my-2 mx-3 mb-2">
                       ...
                       <div class="flex items-center justify-between pt-2">
                           ...
                           <button :disabled="isAlreadyInCart" @click="addCart(product)" class="bg-yellow-400 px-2 font-bold text-sm rounded-lg border shadow-sm cursor-pointer">
